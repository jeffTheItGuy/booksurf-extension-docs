...
### Bookmark Data
Booksurf accesses your Chrome bookmarks solely to display, organize, and manage them within the extension. This data:
- Never leaves your device
- Is never transmitted to any external server
- Is never shared with third parties

### Extension Settings & Preferences
Your customization settings (themes, presets, layout preferences, etc.) are stored locally using the Chrome `storage` API. This data:
- Stays on your device and syncs only through your own Chrome account if you have Chrome Sync enabled
- Is never accessed by us
...
- Bookmark content, titles, or URLs
